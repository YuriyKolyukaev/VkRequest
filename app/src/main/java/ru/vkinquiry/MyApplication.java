...
import ru.vkinquiry.di.component.ApplicationComponent;
import ru.vkinquiry.di.component.DaggerApplicationComponent;
...
public class MyApplication extends Application {
    ...
    // метод для получения компонента (Dagger'а)
