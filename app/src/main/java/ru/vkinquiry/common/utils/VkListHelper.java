package ru.vkinquiry.common.utils;
...
import ru.vkinquiry.model.view.attachment.AudioAttachmentViewModel;
import ru.vkinquiry.model.view.attachment.DocAttachmentViewModel;
import ru.vkinquiry.model.view.attachment.DocImageAttachmentViewModel;
...
import ru.vkinquiry.model.view.attachment.LinkExternalViewModel;
import ru.vkinquiry.model.view.attachment.PageAttachmentViewModel;
import ru.vkinquiry.model.view.attachment.VideoAttachmentViewModel;
import ru.vkinquiry.rest.model.response.ItemWithSendersResponse;

public class VkListHelper {
    public static List<WallItem> getWallList (ItemWithSendersResponse<WallItem> response) {         // будет заполнять поля senderName и senderPhoto для отправителя записи,
        List<WallItem> wallItems = response.items;                                                  // а также для отправителя репоста если запись является репостом
        ...
        for (WallItem wallItem : wallItems) {
            ...
            wallItem.setAttachmentsString(Utils.convertAttachmentsToFontIcons(
                    wallItem.getAttachments()));
