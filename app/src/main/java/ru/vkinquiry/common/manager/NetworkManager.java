...
/* С помощью этого класса проверяем имеет ли устройство доступ в интернет и доступен ли
сервер VKApi*/
public class NetworkManager {
    ...
    public boolean isOnline() {
        ...
        NetworkInfo networkInfo = cm.getActiveNetworkInfo();// возможна ошибка, время 28:35
    ...
    public Observable<Boolean> getNetworkObservable() {
        return io.reactivex.Observable.fromCallable(isVkReachableCallable());
    }
}
