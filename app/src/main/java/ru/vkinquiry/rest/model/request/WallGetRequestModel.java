...
import ru.vkinquiry.rest.model.request.BaseRequestModel;

public class WallGetRequestModel extends BaseRequestModel {                                         // для конкретоного запроса стены
    ...
    @SerializedName(VKApiConst.EXTENDED)                                                            // значение переменной всегда равно единице для получения массивов из profiles и groups.
    int extended = 1;
    ...
    @Override
    public void onMapCreate(Map<String, String> map) {                                              // метод для создания модели запроса
