...
public class GroupsGetMembersRequerstModel extends BaseRequestModel {
    ...
    public GroupsGetMembersRequerstModel(int groupId) {
        this.groupId = Math.abs(groupId);
    }

    public GroupsGetMembersRequerstModel(int groupId, int count, int offset) {
        this.groupId = Math.abs(groupId);
        this.count = count;
        this.offset = offset;
    }
